...
class TDQLearning(Agent):
    def __init__(self, env=None, module_path=None, number_of_episodes=20000, gamma=0.999, alpha=0.1, epsilon=1.,
        ...
        """
        Implementation of the Q-Learning algorithm (cf. Watkins, 1989)
        ...
        logging.info("Initialise Q-Learning agent")
    ...
    def train(self):
        ...
        logging.getLogger(__name__).info("prepare training...")
        ...
        logging.getLogger(__name__).info("Use param: alpha: " + str(self.alpha) + " gamma: " + str(self.gamma))
        ...
        for i in range(self.number_of_episodes):
            ...
            while not done:
                ...
                action = self.max_action(observation, self.env.possible_actions) if np.random.random() < (1 - self.epsilon) \
        ...
        logging.getLogger(__name__).info("End training process")
...
if __name__ == '__main__':
    ...
    agent = TDQLearning(env=env, module_path=module_path, number_of_episodes=number_of_episodes)
